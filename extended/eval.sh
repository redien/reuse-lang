...
if [ "$3" == "--stdin" ]
then
    echo "(typ boolean True False) (typ (result a b) (Result a) (Error b)) (typ (list a) (Cons a (list a)) Empty) $1 (export main$random_name (stdin) $2)" > $program_source
    ...
    echo "(typ boolean True False) (typ (result a b) (Result a) (Error b)) (typ (list a) (Cons a (list a)) Empty) $1 (export main$random_name () $2)" > $program_source
    $script_path/$IMPL/compile-library.sh $program_source $generated_folder
