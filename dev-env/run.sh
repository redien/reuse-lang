...
run() {
    case $1 in
        ...
        test-stdlib-string)             $project_root/standard-library/build-for-test.sh && $project_root/dev-env/spec-runner/run.sh standard-library/specification/string.spec $project_root/standard-library/eval.sh | $project_root/dev-env/tap-format/tap-format.sh ;;
        test-stdlib-bigint)             $project_root/standard-library/build-for-test.sh && $project_root/dev-env/spec-runner/run.sh standard-library/specification/bigint.spec $project_root/standard-library/eval.sh | $project_root/dev-env/tap-format/tap-format.sh ;;
