...
data Tindexed_45iterator element = forall collection. CIndexedIterator !collection !Int32 !(collection -> Int32 -> (Tmaybe element)) !((Tindexed_45iterator element) -> collection -> Int32 -> (Tindexed_45iterator element))
indexed_45iterator_45next = \ !iterator -> (case iterator of (CIndexedIterator !collection !index !_95 !next) -> (next iterator collection index))
indexed_45iterator_45get = \ !iterator -> (case iterator of (CIndexedIterator !collection !index !get !_95) -> (get collection index))
indexed_45iterator_45index = \ !iterator -> (case iterator of (CIndexedIterator !_95 !index !_95_95 !_95_95_95) -> index)
indexed_45iterator_45from_45next_39 = \ !iterator !_95 !_95_95 -> (case iterator of (CIndexedIterator !s !i !get !next) -> (CIndexedIterator s (_int32_add i 1) get next))
indexed_45iterator_45from = \ !collection !get -> (CIndexedIterator collection 0 get indexed_45iterator_45from_45next_39)
...
list_45collect_45from_45indexed_45iterator_39 = \ !predicate !iterator !initial -> (case (indexed_45iterator_45get iterator) of CNone -> (CPair iterator initial) ; (CSome !x) -> (case (predicate x) of CTrue -> (list_45collect_45from_45indexed_45iterator_39 predicate (indexed_45iterator_45next iterator) (CCons x initial)) ; CFalse -> (CPair iterator initial)))
