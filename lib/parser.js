...
var parse_45atom = (function (program, program_45length, index, row, row_45start) { return (function (parse_45atom_45value) { return (function (value) { return (function (next_45index) { return intermediate_45result_45new(parse_45tree_58atom(value, row, _43(_45(index, row_45start), 1)), next_45index, row, row_45start); })(_43(index, _string_length(value))); })(parse_45atom_45value(program, program_45length, index, '')); })((function (program, program_45length, index, value) { var recur = _generate_recursive_function(arguments); while (true) { var result; result = (_60(index, program_45length) ? (function (character) { return (part_45of_45atom_63(character) ? recur(program, program_45length, _43(index, 1), _string_push(value, character)) : value); })(_charCodeAt(program, index)) : value); if (result !== null && typeof result === "object" && result._reuse_isRecurValue) { continue; } break; } return result; })); });
var string_45end_63 = (function (program, program_45length, index) { return _62_61(index, program_45length); });
var close_45parenthesis_63 = (function (program, program_45length, index) { return and(_60(index, program_45length), (function (character) { return _61_61(character, close_45parenthesis); })(_charCodeAt(program, index))); });
