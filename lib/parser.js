...
var intermediate_45result_45new = (function (expression, index) { return cons(0, cons(expression, index)); });
var intermediate_45result_45expression = (function (result) { return first(rest(result)); });
var intermediate_45result_45index = (function (result) { return rest(rest(result)); });
...
var parse_45atom = (function (program, index) { return (function (parse_45atom_45value) { return (function (result) { return (function (value) { return (function (next_45index) { return intermediate_45result_45new(parse_45tree_58atom(value, 0, index), next_45index); })(intermediate_45result_45index(result)); })(intermediate_45result_45expression(result)); })(parse_45atom_45value(program, index, '')); })((function (program, index, value) { var recur = _generate_recursive_function(arguments); while (true) { var result; result = (_60(index, _string_length(program)) ? (function (character) { return (part_45of_45atom_63(character) ? recur(program, _43(index, 1), _string_push(value, character)) : intermediate_45result_45new(value, index)); })(_charCodeAt(program, index)) : intermediate_45result_45new(value, index)); if (result !== null && typeof result === "object" && result._reuse_isRecurValue) { continue; } break; } return result; })); });
var parse_45list = (function self(program, index, list) { var recur = _generate_recursive_function(arguments); while (true) { var result; result = (_60(index, _string_length(program)) ? (function (character) { return (_61_61(character, open_45parenthesis) ? (function (result) { return (intermediate_45result_45error_63(result) ? result : (function (child_45list) { return (function (next_45index) { return recur(program, next_45index, parse_45tree_58push(list, child_45list)); })(intermediate_45result_45index(result)); })(intermediate_45result_45expression(result))); })(self(program, _43(index, 1), parse_45tree_58list())) : (_61_61(character, close_45parenthesis) ? intermediate_45result_45new(list, _43(index, 1)) : (whitespace_63(character) ? recur(program, _43(index, 1), list) : (function (result) { return (function (atom) { return (function (next_45index) { return recur(program, next_45index, parse_45tree_58push(list, atom)); })(intermediate_45result_45index(result)); })(intermediate_45result_45expression(result)); })(parse_45atom(program, index))))); })(_charCodeAt(program, index)) : intermediate_45result_45new_45error()); if (result !== null && typeof result === "object" && result._reuse_isRecurValue) { continue; } break; } return result; });
var parse_45expression = (function (program, index) { var recur = _generate_recursive_function(arguments); while (true) { var result; result = (_60(index, _string_length(program)) ? (function (character) { return (_61_61(character, open_45parenthesis) ? parse_45list(program, _43(index, 1), parse_45tree_58list()) : (whitespace_63(character) ? recur(program, _43(index, 1)) : (_61_61(character, close_45parenthesis) ? intermediate_45result_45new_45error() : parse_45atom(program, index)))); })(_charCodeAt(program, index)) : intermediate_45result_45new(nil, index)); if (result !== null && typeof result === "object" && result._reuse_isRecurValue) { continue; } break; } return result; });
var parse_45statements = (function (program, index, statements) { var recur = _generate_recursive_function(arguments); while (true) { var result; result = (function (intermediate_45result) { return (intermediate_45result_45error_63(intermediate_45result) ? intermediate_45result : (function (parsed_45expression) { return (function (next_45index) { return (nil_63(parsed_45expression) ? intermediate_45result_45new(statements, next_45index) : recur(program, next_45index, parse_45tree_58push(statements, parsed_45expression))); })(intermediate_45result_45index(intermediate_45result)); })(intermediate_45result_45expression(intermediate_45result))); })(parse_45expression(program, index)); if (result !== null && typeof result === "object" && result._reuse_isRecurValue) { continue; } break; } return result; });
var parse = (function (program) { return (function (intermediate_45result) { return (intermediate_45result_45error_63(intermediate_45result) ? unbalanced_45parentheses_45error : (function (parsed_45program) { return result(parsed_45program); })(intermediate_45result_45expression(intermediate_45result))); })(parse_45statements(program, 0, parse_45tree_58list())); }); module.exports.parse = parse;
