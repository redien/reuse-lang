...
var parse_45expression = (function (program, index, row) { return (function (character) { return (_61_61(character, open_45parenthesis) ? parse_45list(program, _43(index, 1), row, parse_45tree_58list(), close_45parenthesis_63, string_45end_63) : parse_45atom(program, index, row)); })(_charCodeAt(program, index)); });
var parse_45list = (function (program, index, row, list, stop_63, error_63) { var recur = _generate_recursive_function(arguments); while (true) { var result; result = (stop_63(program, index) ? intermediate_45result_45new(list, _43(index, 1), row) : (error_63(program, index) ? intermediate_45result_45new_45error() : (function (character) { return (_61_61(character, line_45feed) ? recur(program, _43(index, 1), _43(row, 1), list, stop_63, error_63) : (whitespace_63(character) ? recur(program, _43(index, 1), row, list, stop_63, error_63) : (function (intermediate_45result) { return (intermediate_45result_45error_63(intermediate_45result) ? intermediate_45result : (function (expression) { return (function (next_45index) { return (function (next_45row) { return recur(program, next_45index, next_45row, parse_45tree_58push(list, expression), stop_63, error_63); })(intermediate_45result_45row(intermediate_45result)); })(intermediate_45result_45index(intermediate_45result)); })(intermediate_45result_45expression(intermediate_45result))); })(parse_45expression(program, index, row)))); })(_charCodeAt(program, index)))); if (result !== null && typeof result === "object" && result._reuse_isRecurValue) { continue; } break; } return result; });
var parse = (function (program) { return (function (intermediate_45result) { return (intermediate_45result_45error_63(intermediate_45result) ? unbalanced_45parentheses_45error : (function (parsed_45program) { return result(parsed_45program); })(intermediate_45result_45expression(intermediate_45result))); })(parse_45list(program, 0, 1, parse_45tree_58list(), string_45end_63, close_45parenthesis_63)); }); module.exports.parse = parse;
