...
var encode = (function (name) { return (function (encode_45with_45accumulator) { return encode_45with_45accumulator(name, _string_length(name), 0, ''); })((function (name, name_45length, index, encoded_45name) { var recur = _generate_recursive_function(arguments); while (true) { var result; result = (function (code_45point) { return (_60(index, name_45length) ? (or(and(_62_61(code_45point, 65), _60_61(code_45point, 90)), and(_62_61(code_45point, 97), _60_61(code_45point, 122))) ? recur(name, name_45length, _43(index, 1), _string_push(encoded_45name, code_45point)) : recur(name, name_45length, _43(index, 1), (_string_push(encoded_45name, 95) + string_58decimal_45string_45from_45integer(code_45point)))) : encoded_45name); })(_charCodeAt(name, index)); if (result !== null && typeof result === "object" && result._reuse_isRecurValue) { continue; } break; } return result; })); }); module.exports.encode = encode;
