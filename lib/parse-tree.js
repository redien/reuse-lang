...
var parse_45tree_58list = (function () { return cons(0, nil); }); module.exports.parse_tree_list = _export(parse_45tree_58list);
...
var parse_45tree_58child = (function (expression, index) { return (function (list) { return (function (count) { return (function (item_45at_45position) { return item_45at_45position(list, 0, index); })((function (list, index, target_45index) { var recur = _generate_recursive_function(arguments); while (true) { var result; result = (and(_60(index, count), _60(index, target_45index)) ? recur(rest(list), _43(index, 1)) : first(list)); if (result !== null && typeof result === "object" && result._reuse_isRecurValue) { continue; } break; } return result; })); })(list_58count(list)); })(rest(expression)); }); module.exports.parse_tree_child = _export(parse_45tree_58child);
var parse_45tree_58count = (function (expression) { return (function (list) { return list_58count(list); })(rest(expression)); }); module.exports.parse_tree_count = _export(parse_45tree_58count);
var parse_45tree_58push = (function (expression, child) { return (function (list) { return (function (push_45back) { return cons(0, push_45back(list, child)); })((function (list, item) { return list_58concatenate(list, cons(item, nil)); })); })(rest(expression)); }); module.exports.parse_tree_push = _export(parse_45tree_58push);
