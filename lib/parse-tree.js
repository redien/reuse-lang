...
var stdlib_47list_46ru_95list_58add = (function (a, b) { return cons(b, a); });
...
var list_58reverse = (function (list) { return list_58reduce(stdlib_47list_46ru_95list_58add, nil, list); });
var list_58reduce_45right = (function (f, initial_45value, list) { return list_58reduce(f, initial_45value, list_58reverse(list)); });
var list_58map = (function (f, list) { return list_58reduce_45right(transducers_58mapping(f)(stdlib_47list_46ru_95list_58add), nil, list); });
var list_58filter = (function (predicate, list) { return list_58reduce_45right(transducers_58filtering(predicate)(stdlib_47list_46ru_95list_58add), nil, list); });
var list_58count = (function (list) { return list_58reduce(transducers_58overriding(1)(_43), 0, list); });
...
var stdlib_47vector_46ru_95iterator_45new = (function (vector, index) { return cons(vector, index); });
var stdlib_47vector_46ru_95iterator_45next = (function (iterator) { return stdlib_47vector_46ru_95iterator_45new(first(iterator), _43(rest(iterator), 1)); });
var stdlib_47vector_46ru_95iterator_45has_45next_63 = (function (iterator) { return _60(rest(iterator), vector_58length(first(iterator))); });
var stdlib_47vector_46ru_95iterator_45code_45point = (function (iterator) { return vector_58element_45at_45index(first(iterator), rest(iterator)); });
var stdlib_47vector_46ru_95reduce_45iterator = (function (f, accumulator, iterator) { var recur = _generate_recursive_function(arguments); while (true) { var result; result = (stdlib_47vector_46ru_95iterator_45has_45next_63(iterator) ? recur(f, f(accumulator, stdlib_47vector_46ru_95iterator_45code_45point(iterator)), stdlib_47vector_46ru_95iterator_45next(iterator)) : accumulator); if (result !== null && typeof result === "object" && result._reuse_isRecurValue) { continue; } break; } return result; });
var vector_58reduce = (function (f, accumulator, vector) { return stdlib_47vector_46ru_95reduce_45iterator(f, accumulator, stdlib_47vector_46ru_95iterator_45new(vector, 0)); });
var vector_58map = (function (f, vector) { return vector_58reduce(transducers_58mapping(f)(vector_58push), vector_58new(), vector); });
var vector_58filter = (function (predicate, vector) { return vector_58reduce(transducers_58filtering(predicate)(vector_58push), vector_58new(), vector); });
...
var stdlib_47string_46ru_95iterator_45new = (function (string, index) { return cons(string, index); });
var stdlib_47string_46ru_95iterator_45next = (function (iterator) { return stdlib_47string_46ru_95iterator_45new(first(iterator), _43(rest(iterator), 1)); });
var stdlib_47string_46ru_95iterator_45has_45next_63 = (function (iterator) { return _60(rest(iterator), string_58length(first(iterator))); });
var stdlib_47string_46ru_95iterator_45code_45point = (function (iterator) { return string_58code_45point_45at_45index(first(iterator), rest(iterator)); });
var stdlib_47string_46ru_95reduce_45iterator = (function (f, accumulator, iterator) { var recur = _generate_recursive_function(arguments); while (true) { var result; result = (stdlib_47string_46ru_95iterator_45has_45next_63(iterator) ? recur(f, f(accumulator, stdlib_47string_46ru_95iterator_45code_45point(iterator)), stdlib_47string_46ru_95iterator_45next(iterator)) : accumulator); if (result !== null && typeof result === "object" && result._reuse_isRecurValue) { continue; } break; } return result; });
var string_58reduce = (function (f, accumulator, string) { return stdlib_47string_46ru_95reduce_45iterator(f, accumulator, stdlib_47string_46ru_95iterator_45new(string, 0)); });
var string_58map = (function (f, string) { return string_58reduce(transducers_58mapping(f)(string_58push), string_58new(), string); });
var string_58filter = (function (predicate, string) { return string_58reduce(transducers_58filtering(predicate)(string_58push), string_58new(), string); });
...
var parse_45tree_58list_45kind = string_58push(string_58push(string_58push(string_58push(string_58new(), 108), 105), 115), 116); module.exports.parse_tree_list_kind = _export(parse_45tree_58list_45kind);
var parse_45tree_58atom_45kind = string_58push(string_58push(string_58push(string_58push(string_58new(), 97), 116), 111), 109); module.exports.parse_tree_atom_kind = _export(parse_45tree_58atom_45kind);
var parse_45tree_58atom = (function (value, line, column) { return cons(1, cons(value, cons(line, cons(column, nil)))); }); module.exports.parse_tree_atom = _export(parse_45tree_58atom);
var parse_45tree_58list = (function () { return cons(0, vector_58new()); }); module.exports.parse_tree_list = _export(parse_45tree_58list);
var parse_45tree_58kind = (function (expression) { return (_61_61(first(expression), 0) ? parse_45tree_58list_45kind : parse_45tree_58atom_45kind); }); module.exports.parse_tree_kind = _export(parse_45tree_58kind);
var parse_45tree_58atom_63 = (function (expression) { return _61_61(first(expression), 1); }); module.exports.is_parse_tree_atom = _export(parse_45tree_58atom_63);
var parse_45tree_58list_63 = (function (expression) { return _61_61(first(expression), 0); }); module.exports.is_parse_tree_list = _export(parse_45tree_58list_63);
var parse_45tree_58value = (function (expression) { return first(rest(expression)); }); module.exports.parse_tree_value = _export(parse_45tree_58value);
var parse_45tree_58line = (function (expression) { return first(rest(rest(expression))); }); module.exports.parse_tree_line = _export(parse_45tree_58line);
var parse_45tree_58column = (function (expression) { return first(rest(rest(rest(expression)))); }); module.exports.parse_tree_column = _export(parse_45tree_58column);
var parse_45tree_58child = (function (expression, index) { return (function (vector) { return vector_58element_45at_45index(vector, index); })(rest(expression)); }); module.exports.parse_tree_child = _export(parse_45tree_58child);
var parse_45tree_58count = (function (expression) { return (function (vector) { return vector_58length(vector); })(rest(expression)); }); module.exports.parse_tree_count = _export(parse_45tree_58count);
var parse_45tree_58push = (function (expression, child) { return (function (vector) { return cons(0, vector_58push(vector, child)); })(rest(expression)); }); module.exports.parse_tree_push = _export(parse_45tree_58push);
var transform_45list = (function (list, child_45index, new_45list, should_45replace_63, replace) { var recur = _generate_recursive_function(arguments); while (true) { var result; result = (_60(child_45index, parse_45tree_58count(list)) ? recur(list, _43(child_45index, 1), parse_45tree_58push(new_45list, parse_45tree_58transform(parse_45tree_58child(list, child_45index), should_45replace_63, replace)), should_45replace_63, replace) : new_45list); if (result !== null && typeof result === "object" && result._reuse_isRecurValue) { continue; } break; } return result; });
var parse_45tree_58transform = (function (parse_45tree, should_45replace_63, replace) { return (should_45replace_63(parse_45tree) ? replace(parse_45tree) : (parse_45tree_58list_63(parse_45tree) ? transform_45list(parse_45tree, 0, parse_45tree_58list(), should_45replace_63, replace) : parse_45tree)); }); module.exports.parse_tree_transform = _export(parse_45tree_58transform);
