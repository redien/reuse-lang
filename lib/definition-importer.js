...
var list_58reduce = (function (f, initial_45value, list) { var self = _generate_recursive_function(arguments); while (true) { var result; result = (nil_63(list) ? initial_45value : self(f, f(initial_45value, first(list)), rest(list))); if (result !== null && typeof result === "object" && result._reuse_isRecurValue) { continue; } break; } return result; });
...
var list_58count = (function (list) { return (function (count_45with_45accumulator) { return count_45with_45accumulator(list, 0); })((function (list, count) { var self = _generate_recursive_function(arguments); while (true) { var result; result = (nil_63(list) ? count : self(rest(list), _43(count, 1))); if (result !== null && typeof result === "object" && result._reuse_isRecurValue) { continue; } break; } return result; })); });
var list_58take = (function (list, n) { return (function (take_45with_45accumulator) { return list_58reverse(take_45with_45accumulator(list, n, nil)); })((function (list, n, new_45list) { var self = _generate_recursive_function(arguments); while (true) { var result; result = (_61_61(n, 0) ? new_45list : (nil_63(list) ? new_45list : self(rest(list), _45(n, 1), cons(first(list), new_45list)))); if (result !== null && typeof result === "object" && result._reuse_isRecurValue) { continue; } break; } return result; })); });
var list_58take_45last = (function (list, n) { return (function (count) { return (function (items_45to_45take) { return (function (list_45at_45hop) { return list_45at_45hop(list, items_45to_45take); })((function (list, index) { var self = _generate_recursive_function(arguments); while (true) { var result; result = (_62(index, 0) ? self(rest(list), _45(index, 1)) : list); if (result !== null && typeof result === "object" && result._reuse_isRecurValue) { continue; } break; } return result; })); })(_45(count, n)); })(list_58count(list)); });
var list_58concatenate = (function (first_45list, second_45list) { return (function (concatenate) { return concatenate(list_58reverse(first_45list), second_45list); })((function (first_45list_45reversed, second_45list) { var self = _generate_recursive_function(arguments); while (true) { var result; result = (nil_63(first_45list_45reversed) ? second_45list : self(rest(first_45list_45reversed), cons(first(first_45list_45reversed), second_45list))); if (result !== null && typeof result === "object" && result._reuse_isRecurValue) { continue; } break; } return result; })); });
...
var parse_45tree_58child = (function (expression, index) { return (function (list) { return (function (count) { return (function (item_45at_45position) { return item_45at_45position(list, 0, index); })((function (list, index, target_45index) { var self = _generate_recursive_function(arguments); while (true) { var result; result = (and(_60(index, count), _60(index, target_45index)) ? self(rest(list), _43(index, 1)) : first(list)); if (result !== null && typeof result === "object" && result._reuse_isRecurValue) { continue; } break; } return result; })); })(list_58count(list)); })(rest(expression)); });
...
var export_45value = _string_push(_string_push(_string_push(_string_push(_string_push(_string_push('', 101), 120), 112), 111), 114), 116);
var import_45value = _string_push(_string_push(_string_push(_string_push(_string_push(_string_push('', 105), 109), 112), 111), 114), 116);
var new_45define_45from_45import_45atom = (function (line, column) { return parse_45tree_58atom(_string_push(_string_push(_string_push(_string_push(_string_push(_string_push(_string_push(_string_push(_string_push(_string_push(_string_push(_string_push(_string_push(_string_push(_string_push(_string_push(_string_push(_string_push('', 100), 101), 102), 105), 110), 101), 45), 102), 114), 111), 109), 45), 105), 109), 112), 111), 114), 116), line, column); });
var module_45list_45contains_63 = (function (module_45list, module_45name) { var self = _generate_recursive_function(arguments); while (true) { var result; result = (nil_63(module_45list) ? false : ((module_45name === first(module_45list)) ? true : self(rest(module_45list), module_45name))); if (result !== null && typeof result === "object" && result._reuse_isRecurValue) { continue; } break; } return result; });
var make_45state = (function (program, statement_45index, module_45name, redefine_45exports) { return cons(program, cons(statement_45index, cons(module_45name, redefine_45exports))); });
var append_45state = (function (state_45list, state) { return cons(state, state_45list); });
var _reserved_import = (function (program, module_45loader) { return (function (convert_45module) { return convert_45module(append_45state(nil, make_45state(program, 0, '', false)), parse_45tree_58list(), nil); })((function (state, new_45program, imported_45modules) { var self = _generate_recursive_function(arguments); while (true) { var result; result = (nil_63(state) ? new_45program : (function (program) { return (function (statement_45index) { return (function (module_45name) { return (function (redefine_45exports) { return (function (state_45for_45next_45statement) { return (function (state_45with_45imported_45module) { return (function (statement) { return (function (form_45name) { return (function (statement) { return (function (new_45program) { return (function (module_45import_63) { return (function (next_45state) { return (function (imported_45modules) { return self(next_45state, new_45program, imported_45modules); })((module_45import_63 ? cons(parse_45tree_58value(parse_45tree_58child(statement, 1)), imported_45modules) : imported_45modules)); })((module_45import_63 ? state_45with_45imported_45module(parse_45tree_58value(parse_45tree_58child(statement, 1))) : state_45for_45next_45statement())); })(and((import_45value === form_45name), not(module_45list_45contains_63(imported_45modules, parse_45tree_58value(parse_45tree_58child(statement, 1)))))); })((or((import_45value === form_45name), _62_61(statement_45index, parse_45tree_58count(program))) ? new_45program : parse_45tree_58push(new_45program, statement))); })((and(redefine_45exports, (export_45value === form_45name)) ? parse_45tree_58push(parse_45tree_58push(parse_45tree_58push(parse_45tree_58push(parse_45tree_58list(), new_45define_45from_45import_45atom(0, 0)), parse_45tree_58child(statement, 1)), parse_45tree_58child(statement, 2)), parse_45tree_58atom(module_45name, 0, 0)) : statement)); })(parse_45tree_58value(parse_45tree_58child(statement, 0))); })(parse_45tree_58child(program, statement_45index)); })((function (module_45name) { return append_45state(state_45for_45next_45statement(), make_45state(module_45loader(module_45name), 0, module_45name, true)); })); })((function () { return (_60(statement_45index, parse_45tree_58count(program)) ? append_45state(rest(state), make_45state(program, _43(statement_45index, 1), module_45name, redefine_45exports)) : rest(state)); })); })(rest(rest(rest(first(state))))); })(first(rest(rest(first(state))))); })(first(rest(first(state)))); })(first(first(state)))); if (result !== null && typeof result === "object" && result._reuse_isRecurValue) { continue; } break; } return result; })); }); module.exports.import = _reserved_import;
