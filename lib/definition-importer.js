...
var _reserved_import = (function (program, module_45loader) { return (function (make_45state) { return (function (append_45state) { return (function (convert_45module) { return convert_45module(append_45state(nil, make_45state(program, 0, '', false)), parse_45tree_58list()); })((function (state, new_45program) { var self = _generate_recursive_function(arguments); while (true) { var result; result = (nil_63(state) ? new_45program : (function (program) { return (function (statement_45index) { return (function (module_45name) { return (function (redefine_45exports) { return (function (state_45for_45next_45statement) { return (function (state_45with_45imported_45module) { return (function (statement) { return (function (form_45name) { return (function (statement) { return (function (new_45program) { return (function (next_45state) { return self(next_45state, new_45program); })(((import_45value === form_45name) ? state_45with_45imported_45module(parse_45tree_58value(parse_45tree_58child(statement, 1))) : state_45for_45next_45statement())); })((or((import_45value === form_45name), _62_61(statement_45index, parse_45tree_58count(program))) ? new_45program : parse_45tree_58push(new_45program, statement))); })((and(redefine_45exports, (export_45value === form_45name)) ? parse_45tree_58push(parse_45tree_58push(parse_45tree_58push(parse_45tree_58push(parse_45tree_58list(), new_45define_45from_45import_45atom(0, 0)), parse_45tree_58child(statement, 1)), parse_45tree_58child(statement, 2)), parse_45tree_58atom(module_45name, 0, 0)) : statement)); })(parse_45tree_58value(parse_45tree_58child(statement, 0))); })(parse_45tree_58child(program, statement_45index)); })((function (module_45name) { return append_45state(state_45for_45next_45statement(), make_45state(module_45loader(module_45name), 0, module_45name, true)); })); })((function () { return (_60(statement_45index, parse_45tree_58count(program)) ? append_45state(rest(state), make_45state(program, _43(statement_45index, 1), module_45name, redefine_45exports)) : rest(state)); })); })(rest(rest(rest(first(state))))); })(first(rest(rest(first(state))))); })(first(rest(first(state)))); })(first(first(state)))); if (result !== null && typeof result === "object" && result._reuse_isRecurValue) { continue; } break; } return result; })); })((function (state_45list, state) { return cons(state, state_45list); })); })((function (program, statement_45index, module_45name, redefine_45exports) { return cons(program, cons(statement_45index, cons(module_45name, redefine_45exports))); })); }); module.exports.import = _reserved_import;
