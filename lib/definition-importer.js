...
var substring = (function (string, start, length, string_45length) { return (_60(length, 0) ? '' : (function (substring_45with_45accumulator) { return substring_45with_45accumulator(start, length, ''); })((function (offset, length, new_45string) { var recur = _generate_recursive_function(arguments); while (true) { var result; result = (or(_61_61(length, 0), _62_61(offset, string_45length)) ? new_45string : recur(_43(offset, 1), _45(length, 1), _string_push(new_45string, _charCodeAt(string, offset)))); if (result !== null && typeof result === "object" && result._reuse_isRecurValue) { continue; } break; } return result; }))); });
var string_58substring = (function (string, start, length) { return substring(string, start, length, _string_length(string)); });
var equal_63 = (function (first_45string, first_45string_45length, second_45string, second_45string_45length) { return (function (code_45point_45equal_63) { return (_33_61(first_45string_45length, second_45string_45length) ? false : code_45point_45equal_63(0)); })((function (index) { var recur = _generate_recursive_function(arguments); while (true) { var result; result = (_60(index, first_45string_45length) ? (_61_61(_charCodeAt(first_45string, index), _charCodeAt(second_45string, index)) ? recur(_43(index, 1)) : false) : true); if (result !== null && typeof result === "object" && result._reuse_isRecurValue) { continue; } break; } return result; })); });
var string_58equal_63 = (function (first_45string, second_45string) { return equal_63(first_45string, _string_length(first_45string), second_45string, _string_length(second_45string)); });
...
var module_45list_45contains_63 = (function (module_45list, module_45name) { var recur = _generate_recursive_function(arguments); while (true) { var result; result = (nil_63(module_45list) ? false : ((module_45name === first(module_45list)) ? true : recur(rest(module_45list), module_45name))); if (result !== null && typeof result === "object" && result._reuse_isRecurValue) { continue; } break; } return result; });
...
var _reserved_import = (function (program, module_45loader) { return (function (convert_45module) { return convert_45module(append_45state(nil, make_45state(program, 0, '', '', false)), parse_45tree_58list(), nil); })((function (state, new_45program, imported_45modules) { var recur = _generate_recursive_function(arguments); while (true) { var result; result = (nil_63(state) ? new_45program : (function (program) { return (function (statement_45index) { return (function (module_45name) { return (function (import_45prefix) { return (function (redefine_45exports) { return (function (statement) { return (function (form_45name) { return (function (module_45import_63) { return (function (import_45prefix) { return (function (state_45for_45next_45statement) { return (function (state_45with_45imported_45module) { return (function (statement) { return (function (new_45program) { return (function (next_45state) { return (function (imported_45modules) { return recur(next_45state, new_45program, imported_45modules); })((module_45import_63 ? cons(parse_45tree_58value(parse_45tree_58child(statement, 1)), imported_45modules) : imported_45modules)); })((module_45import_63 ? state_45with_45imported_45module(parse_45tree_58value(parse_45tree_58child(statement, 1))) : state_45for_45next_45statement())); })((or((import_45value === form_45name), _62_61(statement_45index, parse_45tree_58count(program))) ? new_45program : parse_45tree_58push(new_45program, statement))); })((and(redefine_45exports, (export_45value === form_45name)) ? parse_45tree_58push(parse_45tree_58push(parse_45tree_58push(parse_45tree_58push(parse_45tree_58list(), new_45define_45from_45import_45atom(0, 0)), parse_45tree_58atom((import_45prefix + parse_45tree_58value(parse_45tree_58child(statement, 1))), 0, 0)), parse_45tree_58child(statement, 2)), parse_45tree_58atom(module_45name, 0, 0)) : statement)); })((function (module_45name) { return append_45state(state_45for_45next_45statement(), make_45state(module_45loader(module_45name), 0, module_45name, import_45prefix, true)); })); })((function () { return (_60(statement_45index, parse_45tree_58count(program)) ? append_45state(rest(state), make_45state(program, _43(statement_45index, 1), module_45name, import_45prefix, redefine_45exports)) : rest(state)); })); })((and(module_45import_63, _61_61(parse_45tree_58count(statement), 3)) ? _string_push(parse_45tree_58value(parse_45tree_58child(statement, 2)), 58) : import_45prefix)); })(and((import_45value === form_45name), not(module_45list_45contains_63(imported_45modules, parse_45tree_58value(parse_45tree_58child(statement, 1)))))); })(parse_45tree_58value(parse_45tree_58child(statement, 0))); })(parse_45tree_58child(program, statement_45index)); })(rest(rest(rest(rest(first(state)))))); })(first(rest(rest(rest(first(state)))))); })(first(rest(rest(first(state))))); })(first(rest(first(state)))); })(first(first(state)))); if (result !== null && typeof result === "object" && result._reuse_isRecurValue) { continue; } break; } return result; })); }); module.exports.import = _reserved_import;
