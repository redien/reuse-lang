...
var parse_45tree_58transform = (function (parse_45tree, should_45replace_63, replace) { return (should_45replace_63(parse_45tree) ? replace(parse_45tree) : (parse_45tree_58list_63(parse_45tree) ? transform_45list(parse_45tree, 0, parse_45tree_58list(), should_45replace_63, replace) : parse_45tree)); });
...
var module_45already_45imported_63 = (function (module_45name, module_45list) { var recur = _generate_recursive_function(arguments); while (true) { var result; result = (nil_63(module_45list) ? false : (string_58equal_63(module_45name, first(module_45list)) ? true : recur(module_45name, rest(module_45list)))); if (result !== null && typeof result === "object" && result._reuse_isRecurValue) { continue; } break; } return result; });
...
var redefine_45export_45statement = (function (statement, module_45name, module_45prefix) { return parse_45tree_58push(parse_45tree_58push(parse_45tree_58push(parse_45tree_58push(parse_45tree_58list(), new_45define_45from_45import_45atom(0, 0)), parse_45tree_58atom(string_58concatenate(module_45prefix, parse_45tree_58value(parse_45tree_58child(statement, 1))), 0, 0)), parse_45tree_58child(statement, 2)), parse_45tree_58atom(module_45name, 0, 0)); });
