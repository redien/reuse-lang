...
var parse_45tree_58list = (function () { return cons(0, vector_58new()); });
...
var parse_45tree_58child = (function (expression, index) { return (function (vector) { return vector_58element_45at_45index(vector, index); })(rest(expression)); });
var parse_45tree_58count = (function (expression) { return (function (vector) { return vector_58length(vector); })(rest(expression)); });
var parse_45tree_58push = (function (expression, child) { return (function (vector) { return cons(0, vector_58push(vector, child)); })(rest(expression)); });
...
var serialize_45list = (function (list, child_45index, string) { var recur = _generate_recursive_function(arguments); while (true) { var result; result = (_60(child_45index, parse_45tree_58count(list)) ? (function (child) { return (function (serialized_45child) { return recur(list, _43(child_45index, 1), string_58concatenate(string, (_60(child_45index, _45(parse_45tree_58count(list), 1)) ? string_58push(serialized_45child, 32) : serialized_45child))); })(parse_45tree_45serializer_58serialize(child)); })(parse_45tree_58child(list, child_45index)) : string); if (result !== null && typeof result === "object" && result._reuse_isRecurValue) { continue; } break; } return result; });
var parse_45tree_45serializer_58serialize = (function (parse_45tree) { return (parse_45tree_58list_63(parse_45tree) ? string_58push(string_58concatenate(string_58push(string_58new(), 40), serialize_45list(parse_45tree, 0, string_58new())), 41) : parse_45tree_58value(parse_45tree)); }); module.exports.parse_tree_serializer_serialize = _export(parse_45tree_45serializer_58serialize);
