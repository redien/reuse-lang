...
var translateLet = function (expression, imports) {
    return '(function (' + translateParameters(ast.expression(expression, 1), 0, 2) + ') { return ' + translateExpression(ast.expression(expression, 2), imports) + '; })(' + translateFunctionArguments(ast.expression(expression, 1), 1, 2, imports) + ')';
};
