...
| (def deriving () 1)
| (def deriving' (deriving) deriving)
> (deriving' 10)
= 10
...
| (def qualified () 1)
| (def qualified' (qualified) qualified)
> (qualified' 10)
= 10
