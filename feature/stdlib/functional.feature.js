...
describe('stdlib/functional.ru', function () {
    var describeAsReduce = function (reduce) {
        return function () {
            it_should_evaluate_expression_to_value_given_program(
                'module.value(3) + module.value(39)',
                42,
                '(import stdlib/functional.ru) (export value (lambda (initial-value) (' + reduce + ' (lambda () 0) initial-value nil)))',
            ...
            it_should_evaluate_expression_to_value_given_program(
                'module.value()',
                50,
                '(import stdlib/functional.ru) (export value (lambda () (' + reduce + ' / 100 (cons 2 nil))))',
            ...
            it_should_evaluate_expression_to_value_given_program(
                'module.value()',
                60,
                '(import stdlib/functional.ru) (export value (lambda () (' + reduce + ' * 1 (cons 2 (cons 3 (cons 10 nil))))))',
                'should recursively combine the first item of the list with the result of itself applied on the rest of the list'
            );
        };
    };
    describe('reduce', describeAsReduce('reduce'));
    describe('foldl', describeAsReduce('foldl'));

    describe('reverse', function () {
        it_should_evaluate_expression_to_value_given_program(
            'JSON.stringify(module.value())',
            'null',
            '(import stdlib/functional.ru) (export value (lambda () (reverse nil)))',
        ...
        it_should_evaluate_expression_to_value_given_program(
            'JSON.stringify(module.value())',
            '[1,null]',
            '(import stdlib/functional.ru) (export value (lambda () (reverse (cons 1 nil))))',
        ...
        it_should_evaluate_expression_to_value_given_program(
            'JSON.stringify(module.value())',
            '[2,[1,null]]',
            '(import stdlib/functional.ru) (export value (lambda () (reverse (cons 1 (cons 2 nil)))))',
        ...
        it_should_evaluate_expression_to_value_given_program(
            'JSON.stringify(module.value())',
            '[5,[4,[3,[2,[1,null]]]]]',
            '(import stdlib/functional.ru) (export value (lambda () (reverse (cons 1 (cons 2 (cons 3 (cons 4 (cons 5 nil))))))))',
    ...
    describe('foldr', function () {
        it_should_evaluate_expression_to_value_given_program(
            'module.value(3) + module.value(39)',
            42,
            '(import stdlib/functional.ru) (export value (lambda (initial-value) (foldr + initial-value nil)))',
            'should return the initial value for an empty list'
        );
        ...
        it_should_evaluate_expression_to_value_given_program(
            'module.value()',
            50,
            '(import stdlib/functional.ru) (export value (lambda () (foldr / 2 (cons 100 nil))))',
        ...
        it_should_evaluate_expression_to_value_given_program(
            'JSON.stringify(module.value())',
            '[1,[2,[3,[4,[5,null]]]]]',
            '(import stdlib/functional.ru) (export value (lambda () (foldr cons nil (cons 1 (cons 2 (cons 3 (cons 4 (cons 5 nil))))))))',
    ...
    describe('map', function () {
        it_should_evaluate_expression_to_value_given_program(
            'JSON.stringify(module.value())',
            'null',
            '(import stdlib/functional.ru) (export value (lambda () (map (lambda (x) x) nil)))',
            'should return an empty list given an empty list'
        );
        ...
        it_should_evaluate_expression_to_value_given_program(
            'JSON.stringify(module.value())',
            '[2,null]',
            '(import stdlib/functional.ru) (export value (lambda () (map (lambda (x) (+ 1 x)) (cons 1 nil))))',
        ...
        it_should_evaluate_expression_to_value_given_program(
            'JSON.stringify(module.value())',
            '[3,[6,[9,[12,null]]]]',
            '(import stdlib/functional.ru) (export value (lambda () (map (lambda (x) (* 3 x)) (cons 1 (cons 2 (cons 3 (cons 4 nil)))))))',
