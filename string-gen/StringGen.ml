...
let rec chunk_45foldr_39 = fun f accumulator index chunk -> (match (_62_61 index (0l)) with CTrue -> (chunk_45foldr_39 f (f (chunk_45get index chunk) accumulator) (Int32.sub index (1l)) chunk) | CFalse -> accumulator);;
let rec chunk_45foldr = fun f initial chunk -> (chunk_45foldr_39 f initial (Int32.sub (chunk_45size chunk) (1l)) chunk);;
...
type string_45node = CFTValue : int32 -> string_45node | CFTChunk : int32 * (int32) chunk -> string_45node | CFTNode2 : int32 * string_45node * string_45node -> string_45node | CFTNode3 : int32 * string_45node * string_45node * string_45node -> string_45node;;
...
let rec string_45node_45size_39 = fun node -> (match node with (CFTValue (_95)) -> (1l) | (CFTChunk (size,_95)) -> size | (CFTNode2 (size,_95,_95_95)) -> size | (CFTNode3 (size,_95,_95_95,_95_95_95)) -> size);;
...
let rec string_45chunk_39 = fun chunk -> (CFTChunk ((chunk_45size chunk),chunk));;
let rec string_45from_45chunk = fun chunk -> (match (_61 (0l) (chunk_45size chunk)) with CTrue -> CFTEmpty | CFalse -> (CFTSingle ((string_45chunk_39 chunk))));;
...
let rec string_45prepend_45chunk = fun chunk string -> (string_45prepend_45node_39 (string_45chunk_39 chunk) string);;
...
let rec string_45append_45chunk = fun chunk string -> (string_45append_45node_39 (string_45chunk_39 chunk) string);;
let rec string_45first_45node_39 = fun node -> (match node with (CFTValue (x)) -> x | (CFTChunk (_95,x)) -> (chunk_45get (0l) x) | (CFTNode2 (_95,x,_95_95)) -> (string_45first_45node_39 x) | (CFTNode3 (_95,x,_95_95,_95_95_95)) -> (string_45first_45node_39 x));;
...
let rec string_45rest_45node_39 = fun node -> (match node with (CFTValue (_95)) -> CNone | (CFTChunk (_95,x)) -> (match (_61 (chunk_45size x) (1l)) with CTrue -> CNone | CFalse -> (CSome ((string_45chunk_39 (chunk_45slice (1l) (Int32.sub (chunk_45size x) (1l)) x))))) | (CFTNode2 (_95,a,b)) -> (match (string_45rest_45node_39 a) with (CSome (node)) -> (CSome ((string_45node2_39 node b))) | CNone -> (CSome (b))) | (CFTNode3 (_95,a,b,c)) -> (match (string_45rest_45node_39 a) with (CSome (node)) -> (CSome ((string_45node3_39 node b c))) | CNone -> (CSome ((string_45node2_39 b c)))));;
...
let rec string_45foldr_45node_39 = fun f node identity -> (match node with (CFTValue (a)) -> (f a identity) | (CFTChunk (_95,chunk)) -> (chunk_45foldr f identity chunk) | (CFTNode2 (_95,a,b)) -> (string_45foldr_45node_39 f a (string_45foldr_45node_39 f b identity)) | (CFTNode3 (_95,a,b,c)) -> (string_45foldr_45node_39 f a (string_45foldr_45node_39 f b (string_45foldr_45node_39 f c identity))));;
...
let rec string_45foldl_45node_39 = fun f node identity -> (match node with (CFTValue (a)) -> (f a identity) | (CFTChunk (_95,chunk)) -> (chunk_45foldl f identity chunk) | (CFTNode2 (_95,b,a)) -> (string_45foldl_45node_39 f a (string_45foldl_45node_39 f b identity)) | (CFTNode3 (_95,c,b,a)) -> (string_45foldl_45node_39 f a (string_45foldl_45node_39 f b (string_45foldl_45node_39 f c identity))));;
