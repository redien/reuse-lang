...
type string = CString : (int32) list -> string;;
let rec string_45to_45list = fun string -> (match string with (CString (list)) -> list);;
let rec string_45from_45list = fun list -> (CString (list));;
let rec _constant_string_45empty = (CString (CEmpty));;let rec string_45empty = fun () -> _constant_string_45empty;;
let rec string_45of_45char = fun character -> (CString ((CCons (character,CEmpty))));;
let rec string_45first = fun string -> (list_45first (string_45to_45list string));;
let rec string_45rest = fun string -> (CString ((list_45rest (string_45to_45list string))));;
let rec string_45cons = fun char string -> (CString ((CCons (char,(string_45to_45list string)))));;
let rec string_45substring = fun start size string -> (CString ((list_45take size (list_45skip start (string_45to_45list string)))));;
let rec string_45concat_39 = fun a b -> (match a with CEmpty -> b | (CCons (x,xs)) -> (CCons (x,(string_45concat_39 xs b))));;
let rec string_45concat = fun a b -> (CString ((string_45concat_39 (string_45to_45list a) (string_45to_45list b))));;
let rec string_45append = fun a b -> (string_45concat b a);;
let rec string_45reverse = fun string -> (CString ((list_45reverse (string_45to_45list string))));;
let rec string_45join_39 = fun separator list -> (match list with (CCons (first,rest)) -> (list_45foldl (fun string joined -> (list_45concat joined (list_45concat separator string))) first rest) | CEmpty -> CEmpty);;
let rec string_45join = fun separator strings -> (CString ((string_45join_39 (string_45to_45list separator) (list_45map string_45to_45list strings))));;
...
let rec string_45trim_45start = fun string -> (CString ((string_45trim_45start_39 (string_45to_45list string))));;
...
let rec string_45empty_63 = fun string -> (match string with (CString (CEmpty)) -> CTrue | _95 -> CFalse);;
let rec string_45equal_63_39 = fun a b -> (match a with (CCons (xa,xas)) -> (match b with (CCons (xb,xbs)) -> (_and (_61 xa xb) (string_45equal_63_39 xas xbs)) | CEmpty -> (list_45empty_63 a)) | CEmpty -> (list_45empty_63 b));;
let rec string_45equal_63 = fun a b -> (string_45equal_63_39 (string_45to_45list a) (string_45to_45list b));;
...
let rec string_45from_45int32 = fun integer -> (CString ((string_45from_45int32_39 integer)));;
